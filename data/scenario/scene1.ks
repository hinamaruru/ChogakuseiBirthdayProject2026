...
if (typeof sf.story1_clear === "undefined") {
sf.story1_clear = 0;
}

if (typeof sf.story2_clear === "undefined") {
sf.story2_clear = 0;
}

if (typeof sf.story3_clear === "undefined") {
sf.story3_clear = 0;
}

if (typeof sf.story4_clear === "undefined") {
sf.story4_clear = 0;
}

if (typeof sf.story5_clear === "undefined") {
sf.story5_clear = 0;
}

if (typeof sf.story6_clear === "undefined") {
sf.story6_clear = 0;
}

if (typeof sf.story7_clear === "undefined") {
sf.story7_clear = 0;
}

if (typeof sf.story8_clear === "undefined") {
sf.story8_clear = 0;
}

if (typeof sf.story9_clear === "undefined") {
sf.story9_clear = 0;
}

if (typeof sf.story10_clear === "undefined") {
sf.story10_clear = 0;
}

if (typeof sf.complete === "undefined") {
sf.complete = 0;
}
